...
services:
  kobocat:
    ...
    ${USE_EXTRA_HOSTS}extra_hosts:
      ...
      ${USE_FAKE_DNS}- ${ZITE_SUBDOMAIN}.${PUBLIC_DOMAIN_NAME}:${LOCAL_INTERFACE_IP}
  ...
  zite:
    ...
    ${USE_BACKEND_NETWORK}  kobo-be-network:
    ${USE_BACKEND_NETWORK}    aliases:
    ${USE_BACKEND_NETWORK}      - zite
    ${USE_BACKEND_NETWORK}      - zite.docker.container
  ...
  zite_worker:
    ...
    ${USE_BACKEND_NETWORK}  kobo-be-network:
    ${USE_BACKEND_NETWORK}    aliases:
    ${USE_BACKEND_NETWORK}      - zite_worker
    ${USE_BACKEND_NETWORK}      - zite_worker.docker.container
  ...
  zite_beat:
    ...
    ${USE_BACKEND_NETWORK}  kobo-be-network:
    ${USE_BACKEND_NETWORK}    aliases:
    ${USE_BACKEND_NETWORK}      - zite_beat
    ${USE_BACKEND_NETWORK}      - zite_beat.docker.container
